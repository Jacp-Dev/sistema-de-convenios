...
<body style="background: #E1E8EE;">
    ...
    <div class="container mt-3">
        <p class="fs-4"> <i class="fa fa-gear fs-3" style="color: #DF6914"></i> Asigar rol al usuario
        </p>
        <p>En esta sección podrás asigar el rol al usuario diligenciando el siguiente formulario.</p>
        <?php
        ...
        $queryUsuarios = "SELECT nombre, id_usuario FROM usuarios WHERE id_usuario NOT IN (SELECT id_usuario FROM usuarios_rol) ORDER BY id_usuario DESC";
        ...
        <form action="./asignarRol.php" method="post">
            <div class="row">
                <div class="col">
                    <label for="id_usuario">Selecione el nombre de usuario</label>
                ...
                <div class="col">
                    <label for="id_roles">Selecione Rol</label>
